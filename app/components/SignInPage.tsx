...
export function SignInPage() {
  return (
    <div className="relative isolate min-h-[calc(100vh-3rem)] overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-br from-primary/5 via-background to-violet-500/5" />
      <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_80%_45%_at_50%_-10%,rgba(99,102,241,0.12),transparent)]" />
